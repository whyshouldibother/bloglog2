    ...
    return (
        <Sidebar className="border-zinc-500 border-r h-full overflow-hidden pt-4 pr-2 pl-4  pb-2 [&_[data-sidebar='sidebar']]:!bg-transparent">
            ...
            <SidebarContent>
                ...
                <SidebarGroupItem menuItems={{label: "Content", items: [{label: "Projects", action: "/admin/projects/", subMenu: projectList.map((item: projectListType) => ({label: item.title, action: `/admin/projects/${item.id}`}))}, {label: "Tags", action: "/admin/tags/"}]}} />
